      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
          <img className='w-full md:max-w-[450px]' src={assets.aboutus} alt="" />
            <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
                ...
                <p className='text-lg md:text-xl'>At DécorEase, we believe that your home should reflect your personality. That is why we offer a seamless shopping experience, from browsing our exclusive collections to secure checkout and reliable delivery. Discover the art of decorating with ease—only at DécorEase!</p>
            </div>
      </div>
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col md:flex-row text-sm mb-20'>
              <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
                    ...
                    <p className='text-gray-600'>At DécorEase, we prioritize quality in every product we offer. From premium materials to meticulous craftsmanship, we ensure durability, style, and customer satisfaction. Your home deserves the best—shop with confidence!</p>
              </div>
              <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
                    <b>Convience:</b>
                    <p className='text-gray-600'>At DécorEase, we make home decorating effortless. With a user-friendly shopping experience, secure payments, and reliable delivery, we ensure a smooth journey from browsing to buying. Style your space with ease!</p>
              </div>
              <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
                    <b>Exceptional Customer Service:</b>
                    <p className='text-gray-600'>At DécorEase, your satisfaction is our priority. Our dedicated support team is here to assist you every step of the way, ensuring a seamless shopping experience. We value your trust and strive to exceed your expectations with prompt responses, hassle-free returns, and personalized assistance.</p>
              </div>
        </div>
          <NewsLetterBox/>
    </div>
